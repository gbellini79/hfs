...
Basically all videos published by [AEX](https://www.youtube.com/arcadeextreme) and [MAME Retro Avengers](https://www.youtube.com/mameretroavengers) have been made with this utility from .inp files ranging between MAME .106 and .259.
...
### Installation
Just extract the [latest release zip file](https://github.com/gbellini79/hfs/releases/latest) somewhere.
